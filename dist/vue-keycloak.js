...
var VueKeyCloak = function VueKeyCloak () {};
...
VueKeyCloak.install = function (Vue, options) {
  ...
  var keycloak$$1 = keycloak(options.keycloakOptions);
  ...
  keycloak$$1.init(options.keycloakInitOptions).success(function (isAuthenticated) {
    ...
    if (isAuthenticated) {
      setTimeout(function () {
        keycloak$$1.updateToken(options.refreshTime + 2)
  ...
  function updateWatchVariables (isAuthenticated) {
  ...
  Object.defineProperty(Vue.prototype, '$keycloak', {
    get: function get () {
      keycloak$$1.ready = watch.ready;
      keycloak$$1.user = watch.user;
      return keycloak$$1
    }
  });
};
